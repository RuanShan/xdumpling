...
HdGame.imgReady = (function() {
    ...
    function a(h, e, f) {
        var d = f ? ".touch": "";
        var g = f ? c.fn: HTMLElement.prototype;
        g["_base_" + h] = g[h];
        g[h] = function() {
            ...
            if (i) {
                if (e) {
                    ...
                    i.$$handle = l[j] = function(m) {
                        if (k && !c(this).data("isMousedown")) {
                            return
                        }
                        var n = f ? m.originalEvent: m;
                        n.changedTouches = b(n);
                        n.touches = b(n);
                        n.targetTouches = b(n);
            ...
            if (k && !e && !c(this).data("isFirstTime")) {
                if (j == 2) {
                    c(this).on("mouseup", l[1],
                    function() {
                        c(this).data("isMousedown", false)
                    });
                    c(this).on("mousedown", l[1],
                    function() {
            ...
            return g["_base_" + h].apply(this, l)
        }
    }
    function b(d) {
        return arr = [{
    ...
    a("on", false, true);
    a("off", true, true);
    a("addEventListener", false);
    a("removeEventListener", true)
})(jQuery);
